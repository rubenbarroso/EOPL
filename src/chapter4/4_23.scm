...
;From exercise 2.25: "The application (unit-subst i t) returns a substitution that replaces symbol i with term
;                     t and replaces any other symbol by its trivial association".
;
;For this exercise, we define tvar-subst
