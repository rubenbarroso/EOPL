  ...
  (lambda (t1 t2 exp)
    (cond
      ...
      ((and (list-type? t1) (list-type? t2))
       (check-equal-type! (list-type->elem t1) (list-type->elem t2) exp))
