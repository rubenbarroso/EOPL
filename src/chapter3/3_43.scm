...
(define eval-expression ;^exp x env -> expval
  (lambda (exp env)
    (cases expression exp
      ...
      (ref-exp (id) (apply-env-ref env id))
...
;The result of the given program should be 1. Verification:
;> (run
;    "let a = 3
;         b = 4
;         swap = proc (x,y)
...
;These are the semantic of the new language:
;
;Expressed Value = Number + ProcVal + Ref(Number) + Ref(ProcVal)
