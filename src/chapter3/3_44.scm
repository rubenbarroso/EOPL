...
;The following given program:
;
;> (run
;    "letrec times4(x) = if x
;                        then +(4,(times4 sub1(x)))
;                        else 0
;     in (times4 3)")
;12
;
...
;12
;
;In this translation, we are basically using a dummy value to bind the
;variable times4, so that it can be found in the environment when it is
;referenced by itself in the definition of the procedure times4.
;This is similar to what we did in exercise 3.40 when we implemented
;even and odd as mutually recursive procedures.
