...
;We simply need to replace the current representation for closures
;by the abstract syntax tree representation of closures from
;exercise 3.27
...
;set-diff and free-vars not implemented
