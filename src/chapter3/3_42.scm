...
(define apply-primitive
  (lambda (prim args)
    (cases primitive prim
      ...
      (array-prim () (make-vector (car args)))
      (arrayref-prim () (array-ref (car args) (cadr args)))
      (arrayset-prim () (array-set! (car args) (cadr args) (caddr args)))
      )))

;we will build arrays internally with vectors
...
;The result of the given program should be 2. Verification:
;
;> (run
;    "let a = array(2)
;         p = proc (x)
